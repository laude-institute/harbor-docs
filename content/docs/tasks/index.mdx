...
# MCP servers available to the agent (optional)
...
<TypeTable
  type={{
    ...
    "environment.mcp_servers": {
      description: "List of MCP servers to make available to the agent. Each entry specifies a server name, transport type, and connection details. See the MCP example for a full walkthrough.",
